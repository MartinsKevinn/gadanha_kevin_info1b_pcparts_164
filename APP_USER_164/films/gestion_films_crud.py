    ...
    if request.method == "POST":
        try:
            if form_add_film.validate_on_submit():
                ...
                strsql_insert_film = """INSERT INTO t_config (id_config,nom_film) VALUES (NULL,%(value_nom_film)s) """
...
def film_update_wtf():
    ...
    try:
        ...
        if form_update_film.validate_on_submit():
            ...
            str_sql_update_nom_film = """UPDATE t_config SET nom_film = %(value_nom_film)s,
                                                            ...
                                                            WHERE id_config = %(value_id_film)s"""
            with DBconnection() as mconn_bd:
            ...
            # Opération sur la BD pour récupérer "id_config" et "intitule_genre" de la "t_user"
            str_sql_id_film = "SELECT * FROM t_config WHERE id_config = %(value_id_film)s"
...
def film_delete_wtf():
    ...
    try:
        ...
        if form_delete_film.submit_btn_del_film.data:
            ...
            str_sql_delete_film = """DELETE FROM t_config WHERE id_config = %(value_id_film)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT * FROM t_config WHERE id_config = %(value_id_film)s"""
