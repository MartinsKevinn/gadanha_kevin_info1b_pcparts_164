...
"""
    ...
    But : Montrer l'utilisation d'une liste déroulante dont le contenu est basé sur la table "t_userrole"
...
class DemoFormSelectWTF(FlaskForm):
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_userrole = SubmitField("Choix userrole")
