...
class FormWTFAjouterUserrole(FlaskForm):
    ...
    nom_genre_wtf = StringField("Clavioter le role ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateUserrole(FlaskForm):
    ...
    nom_genre_update_wtf = StringField("Clavioter le role ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFDeleteUserrole(FlaskForm):
    """
        ...
        nom_userrole_delete_wtf : Champ qui reçoit la valeur du genre, lecture seule. (readonly=true)
        submit_btn_del : Bouton d'effacement "DEFINITIF".
        submit_btn_conf_del : Bouton de confirmation pour effacer un "genre".
        submit_btn_annuler : Bouton qui permet d'afficher la table "t_genre".
    """
    nom_userrole_delete_wtf = StringField("Effacer ce genre")
