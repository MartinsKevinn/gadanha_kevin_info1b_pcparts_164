...
"""
    ...
    But : Afficher les cpu avec les cpumanufacturer associés pour chaque film.
    
    Paramètres : id_cpu_manufacturer_sel = 0 >> tous les cpu.
                 id_cpu_manufacturer_sel = "n" affiche le film dont l'id est "n"
...
"""
    ...
    Récupère la liste de tous les cpumanufacturer du film sélectionné par le bouton "MODIFIER" de "cpu_cpumanufacturer_afficher.html"
    
    Dans une liste déroulante particulière (tags-selector-tagselect), on voit :
    1) Tous les cpumanufacturer contenus dans la "t_cpumanufacturer".
    2) Les cpumanufacturer attribués au film selectionné.
    3) Les cpumanufacturer non-attribués au film sélectionné.
...
def edit_cpumanufacturer_cpu_selected():
    if request.method == "GET":
        try:
            ...
            # 2) Sélection des cpumanufacturer "déjà" attribués pour le film.
            # 3) Sélection des cpumanufacturer "pas encore" attribués pour le film choisi.
...
def update_cpumanufacturer_cpu_selected():
    if request.method == "POST":
        try:
            ...
            # Récupère la liste des cpumanufacturer qui ne sont pas associés au film sélectionné.
            ...
            # Récupère la liste des cpumanufacturer qui sont associés au film sélectionné.
            ...
            with DBconnection() as mconn_bd:
                # Pour le film sélectionné, parcourir la liste des cpumanufacturer à INSÉRER dans la "t_cpumanufacturer_produce_cpu".
                # Si la liste est vide, la boucle n'est pas parcourue.
                for id_cpumanufacturer_ins in lst_diff_cpumanufacturer_insert_a:
                    # Constitution d'un dictionnaire pour associer l'id du film sélectionné avec un nom de variable
                    # et "id_cpumanufacturer_ins" (l'id du genre dans la liste) associé à une variable.
                ...
                # Pour le film sélectionné, parcourir la liste des cpumanufacturer à EFFACER dans la "t_cpumanufacturer_produce_cpu".
                # Si la liste est vide, la boucle n'est pas parcourue.
                for id_cpumanufacturer_del in lst_diff_cpumanufacturer_delete_b:
                    # Constitution d'un dictionnaire pour associer l'id du film sélectionné avec un nom de variable
                    # et "id_cpumanufacturer_del" (l'id du genre dans la liste) associé à une variable.
                    valeurs_cpu_sel_cpumanufacturer_sel_dictionnaire = {"value_fk_cpu": id_cpu_selected,
    ...
    # on affiche les cpu et le(urs) genre(s) associé(s).
