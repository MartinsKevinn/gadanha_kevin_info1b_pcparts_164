...
def user_config_afficher(id_user_sel):
        ...
        try:
            with DBconnection() as mc_afficher:
                strsql_config_user_afficher_data = """SELECT id_user, user_firstname, user_lastname, user_birthdate,
                                                            GROUP_CONCAT(config_use_case) as UserConfig FROM t_user_created_config
    ...
    return render_template("films_genres/user_config_afficher.html", data=data_config_user_afficher)
...
"""
    ...
    Récupère la liste de tous les genres du film sélectionné par le bouton "MODIFIER" de "user_config_afficher.html"
    
    Dans une liste déroulante particulière (tags-selector-tagselect), on voit :
    1) Tous les genres contenus dans la "t_config".
...
def edit_config_user_selected():
    ...
    return render_template("films_genres/user_config_modifier_tags_dropbox.html",
