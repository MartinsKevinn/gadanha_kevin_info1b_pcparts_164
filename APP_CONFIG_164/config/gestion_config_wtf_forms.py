...
class FormWTFAjouterConfig(FlaskForm):
    ...
    nom_config_wtf = StringField("Clavioter le genre ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateConfig(FlaskForm):
    ...
    config_use_case_update_wtf = StringField("Clavioter le genre ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFDeleteConfig(FlaskForm):
    """
        ...
        nom_config_delete_wtf : Champ qui reçoit la valeur du genre, lecture seule. (readonly=true)
        submit_btn_del : Bouton d'effacement "DEFINITIF".
        submit_btn_conf_del : Bouton de confirmation pour effacer un "genre".
        submit_btn_annuler : Bouton qui permet d'afficher la table "t_config".
    """
    nom_config_delete_wtf = StringField("Effacer ce genre")
