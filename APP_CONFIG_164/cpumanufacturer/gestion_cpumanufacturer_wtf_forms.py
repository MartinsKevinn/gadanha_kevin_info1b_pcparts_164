...
class FormWTFAjouterCpumanufacturer(FlaskForm):
    ...
    nom_cpumanufacturer_wtf = StringField("Clavioter le manufacturer ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateCpumanufacturer(FlaskForm):
    ...
    nom_cpumanufacturer_update_wtf = StringField("Clavioter le manufacturer ", validators=[Length(min=2, max=20, message="min 2 max 20"),
    ...
    date_cpumanufacturer_wtf_essai = DateField("Essai date", validators=[InputRequired("Date obligatoire"),
